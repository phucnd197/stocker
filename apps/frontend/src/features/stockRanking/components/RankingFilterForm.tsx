...
export function RankingFilterForm({
  ...
  const handleFieldChange = (field: keyof RankingFormValues) => (
    ...
    <Box sx={{ mb: 3 }}>
      <Box sx={{ display: "flex", gap: 2, alignItems: "flex-start" }}>
        <TextField
          ...
          helperText={errors.minimumMarketcap || "Filter by minimum market capitalization"}
          type="number"
          fullWidth
        ...
        <TextField
          ...
          helperText={errors.numberOfStocks || "Number of top-ranked stocks to return"}
          type="number"
          sx={{ width: 200 }}
